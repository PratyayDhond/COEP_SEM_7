...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "ADD", "SUB", "MUL", "DIV", "MOD", "POW", "VARIABLE", "num",
  "$accept", "line", "expr", "term", "pow", "factor", YY_NULLPTR
};
...
{
      -3,    -2,    11,   -13,     8,    14,     5,    -9,   -13,     0,
      -2,   -13,    -2,    -2,    -2,    -2,    -2,    -2,   -13,    14,
       5,     5,    -9,    -9,    -9,   -13
};
...
{
       0,     0,     4,    15,     0,     3,     7,    11,    13,     0,
       0,     1,     0,     0,     0,     0,     0,     0,    14,     2,
       5,     6,     8,     9,    10,    12
};
...
{
       1,     1,    17,     9,    18,    25,    12,    13,    11,     2,
       3,     3,    19,    14,    15,    16,    10,    22,    23,    24,
      12,    13,    20,    21
};

static const yytype_int8 yycheck[] =
{
       3,     3,    11,     1,     4,    17,     6,     7,     0,    12,
      13,    13,    10,     8,     9,    10,     5,    14,    15,    16,
       6,     7,    12,    13
};
...
{
       0,     3,    12,    13,    15,    16,    17,    18,    19,    16,
       5,     0,     6,     7,     8,     9,    10,    11,     4,    16,
      17,    17,    18,    18,    18,    19
};
...
#line 39 "unambiguous.y"
                               {(yyval.p)=(yyvsp[-2].p) - (yyvsp[0].p);}
#line 1195 "y.tab.c"
    break;

  case 8: /* term: term MUL pow  */
#line 42 "unambiguous.y"
                           {(yyval.p)=(yyvsp[-2].p) * (yyvsp[0].p);}
#line 1201 "y.tab.c"
    break;

  case 9: /* term: term DIV pow  */
#line 43 "unambiguous.y"
                           {(yyval.p)=(yyvsp[-2].p) / (yyvsp[0].p);}
#line 1207 "y.tab.c"
    break;

  case 10: /* term: term MOD pow  */
#line 44 "unambiguous.y"
                           {(yyval.p)=(yyvsp[-2].p) - (floor((yyvsp[-2].p)/(yyvsp[0].p)) * (yyvsp[0].p));}
#line 1213 "y.tab.c"
    break;

  case 12: /* pow: pow POW factor  */
#line 47 "unambiguous.y"
                    {(yyval.p) = pow((yyvsp[-2].p),(yyvsp[0].p));}
#line 1219 "y.tab.c"
    break;

  case 14: /* factor: OPEN_BR expr CLOSE_BR  */
#line 49 "unambiguous.y"
                                         {(yyval.p) = (yyvsp[-1].p);}
#line 1225 "y.tab.c"
    break;
